...
#ifndef ESAT_TelecommandStorage_h
#define ESAT_TelecommandStorage_h
...
// Use the global instance ESAT_TelecommandStorage.
class ESAT_TelecommandStorageClass
{
  public:
    ...
    // Erase the contents of the telecommand store.
    // Set the error flag on input/output error.
    void erase();
...
extern ESAT_TelecommandStorageClass ESAT_TelecommandStorage;

#endif /* ESAT_TelecommandStorage_h */
